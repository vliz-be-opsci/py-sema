...
from sema.commons.ogm import GraphBuilder, ObjectGraphMapper
...
def test_object_graph_mapper():
    class OGMLike(ObjectGraphMapper):
        ...
        def _map(self):
            return GraphBuilder(
                ...
                },  # overriding default value to circumvent rdflib bug (https://github.com/RDFLib/rdflib/issues/1216) # noqa: E501
    ...
    g0 = Graph().parse(
        "./tests/commons/ogm/data/object_graph_mapping_expected.ttl"
    )
